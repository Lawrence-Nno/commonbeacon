...
session roles. Ordinary community endpoint behavior is unchanged. Inactive imported
accounts and their checks remain future work; the account model currently has no
inactive state.

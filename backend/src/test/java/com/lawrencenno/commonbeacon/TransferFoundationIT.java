...
class TransferFoundationIT {
    ...
    @BeforeEach void setup() throws IOException {
        jdbc.execute("TRUNCATE imported_record,transfer_activation,transfer_stage,transfer_dry_run,transfer_inspection,transfer_download,transfer_audit,transfer_completion,transfer_mapping,transfer_artifact,transfer_attempt,transfer_request,transfer_job");
